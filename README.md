...
- You’ll also see accounts under [#](#) or `yenio` or `NavigoFTW` or `Navigo` (sometimes we couldn’t get just Navigo)
...
- `Navigoi` or `Yenni` (what community members named the company mascot, the [Navigoicorn](#))
